        ...
        <>
            ...
            <div className="container mx-auto mt-[60px]">
                <div className="relative border rounded-2xl overflow-hidden p-2">
                    <img src={images.bgUser} alt="Background User" className="h-[130px] w-full bg-cover rounded-2xl" />
                    ...
                    <div className="absolute top-[24px] left-[50px] ">
                        <div className="p-1 w-[120px] h-[120px] rounded-full overflow-hidden bg-white shadow-md">
                            <img src={images.avatar} alt="" className=" bg-cover rounded-full border border-solid" />
                            <label
                                htmlFor="user-avatar"
