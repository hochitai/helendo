...
function Home() {
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            />
            <QuickViewContext.Provider value={handleShowQuickView}>
                <CustomCarousel title="Best Selling" quantityInSlide={3} comp={ProductItem} className="pt-[120px]" />
            </QuickViewContext.Provider>
            <div className="pt-[130px]">
                ...
                >
                    <div className="content width-content mx-auto ">
                        <div className="w-1/2">
                            <h2 className="offer-colection-title relative text-[36px] font-medium pb-[10px] mb-[30px] bg-primary-hover after:left-0 after:bottom-0 after:h-[4px] after:w-[70px]">
                                Deco Collection <span className="offer text-red-500">50% OFF</span>
                            </h2>
                            <p className="mb-[50px]">
                                The standard chunk of Lorem Ipsum used since the 1500s is reproduced for those. Sections
